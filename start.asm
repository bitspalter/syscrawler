...
section .data
   ...
   ;FInput       dq       0x00     ; file handle
   
   Counter      dq       0x00     ; 
   
   ;NREAD        dq       0x00     ; bytes read
   ...
   cInput       equ      0x00     ; qword [rsp + 0x00], rax  ; cInput
   pInput       equ      0x08     ; qword [rsp + 0x08], rsi  ; pInput      
   pFile        equ      0x10     ; qword [rsp + 0x10], 0x00 ; pFile
   cBuffer      equ      0x18     ; qword [rsp + 0x18], 0x00 ; cBuffer (getdents64)
   cFName       equ      0x20     ; qword [rsp + 0x20], 0x00 ; pFileName
   pFName       equ      0x28     ; qword [rsp + 0x28], 0x00 ; cFileName
   
   ;///////////////////////////////////
   
   pSTRING      equ      cSTACKVq
   cSTRING      equ      0x1100
   
   ; //////////////
   
   pDIR64       equ      cSTACKVq + cSTRING
   cDIR64       equ      0xF000
...
FZERO_RDY:    write       rsi,           rax            ; write to stdout
              write       NEW_LINE,      1              ; write to stdout
